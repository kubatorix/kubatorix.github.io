...
(function () {
    ...
    var BURGER_MENU_HTML = ''
        ...
        +         '<a href="https://t.me/sredasvoih" target="_blank" onclick="window.open(\'https://t.me/sredasvoih?utm_source=site&utm_medium=email&utm_campaign=spec&utm_term=fundraising\',\'_blank\',\'noopener,noreferrer\'); return false;"><img src="' + root + 'img/icons/tg.svg" class="footer-social" /></a>'
        +         '<a href="https://vk.com/sredasvoih" target="_blank" onclick="window.open(\'https://vk.com/sredasvoih?utm_source=site&utm_medium=email&utm_campaign=spec&utm_term=fundraizing\',\'_blank\',\'noopener,noreferrer\'); return false;"><img src="' + root + 'img/icons/vk.svg" class="footer-social" /></a>'
        +       '</div>'
        +     '</div>'
        +   '</div>'
        + '</div>';
